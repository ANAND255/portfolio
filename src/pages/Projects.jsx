...
const PROJECTS = [
  {
    n:'01', badge:'Dashboard', title:'Real-Time Stock Market Dashboard',
    ...
    hi:['Built Python pipeline using yfinance API to fetch and stream live stock data for multiple US equities in real time.','Integrated Power BI Service with automated dataset refresh, dynamic slicers, and advanced DAX measures for trend analysis.','User-defined watchlists via customisable Python script. Full documentation and version control on GitHub.'],
    tags:['Python','yfinance','Pandas','Power BI','DAX','GitHub'],
    gh:'https://github.com/ANAND255',
    period:'Sep 2025',
  },
  {
    n:'02', badge:'Machine Learning', title:'Heart Disease Detection',
      ...
      <section className="sec">
        <div className="wrap">
          ...
          <div className="proj-cards">
            {list.map(p => (
              <div className="pc" key={p.title} data-n={p.n}>
                ...
                <div className="pc-body">
                  ...
                  <p>{p.desc}</p>
                  <div className="pc-hi">
                    {p.hi.map((h,i) => <div className="hi-row" key={i}>{h}</div>)}
                  </div>
                </div>
          ...
          <div className="training-block" style={{marginTop:40}}>
            ...
            <div className="training-inner">
              ...
              <div className="training-right">
                <div className="t-stat"><div className="ts-val">6</div><div className="ts-lbl">Weeks Duration</div></div>
                <div className="t-stat"><div className="ts-val">2</div><div className="ts-lbl">Projects Delivered</div></div>
                <div className="t-stat"><div className="ts-val">100%</div><div className="ts-lbl">Completion Rate</div></div>
              </div>
            </div>
          </div>
        </div>
