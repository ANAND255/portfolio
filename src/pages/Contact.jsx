...
const CIS=[
  {Icon:Mail,label:'Email',val:'anandbijoy255@gmail.com',href:'mailto:anandbijoy255@gmail.com'},
  {Icon:Phone,label:'Phone',val:'+91 8714575989',href:'tel:+918714575989'},
  {Icon:Loc,label:'Location',val:'Punjab, India',href:null},
  {Icon:Uni,label:'University',val:'LPU, Punjab',href:null}
]
  ...
  return (
    <main className="page">
      <div className="banner">
        ...
        <div className="wrap">
          <span className="tag u1">Get In Touch</span>
          <div className="lg u2" style={{marginTop:18}}>Contact</div>
          <p className="banner-sub u3">Open to internships, collaborations, and data conversations.</p>
        </div>
      </div>
            ...
            <Reveal dir="left">
              <div className="c-info">
                ...
                <div className="ci-list">
                  {CIS.map(ci => (
                    <div className="ci-row" key={ci.label}>
                      <div className="ci-icon"><ci.Icon /></div>
                      <div>
                        <div className="ci-lbl">{ci.label}</div>
                        {ci.href
                          ? <a href={ci.href} className="ci-val">{ci.val}</a>
                          : <span className="ci-val">{ci.val}</span>
                        }
                      </div>
                    </div>
                  ))}
              ...
              <div className="form-box">
                {sent ? (
                  <div className="success">
                    <div className="s-icon"><Check /></div>
                    <h4>Message Sent!</h4>
                  ...
                  <>
                    ...
                    <form onSubmit={submit} noValidate>
                      ...
                      <button type="submit" className="btn btn-w submit" disabled={loading}>
