...
const LogoPython = () => (
  <svg viewBox="0 0 256 255" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="pA" x1="12%" x2="80%" y1="12%" y2="78%"><stop offset="0%" stopColor="#387EB8"/><stop offset="100%" stopColor="#366994"/></linearGradient>
      <linearGradient id="pB" x1="19%" x2="91%" y1="21%" y2="88%"><stop offset="0%" stopColor="#FFE052"/><stop offset="100%" stopColor="#FFC331"/></linearGradient>
    </defs>
    <path fill="url(#pA)" d="M126.916.072c-64.832 0-60.784 28.115-60.784 28.115l.072 29.128h61.868v8.745H41.631S.145 61.355.145 126.77c0 65.417 36.21 63.097 36.21 63.097h21.61v-30.356s-1.165-36.21 35.632-36.21h61.362s34.475.557 34.475-33.319V33.97S194.67.072 126.916.072zM92.802 19.66a11.12 11.12 0 0 1 11.13 11.13 11.12 11.12 0 0 1-11.13 11.13 11.12 11.12 0 0 1-11.13-11.13 11.12 11.12 0 0 1 11.13-11.13z"/>
    <path fill="url(#pB)" d="M128.757 254.126c64.832 0 60.784-28.115 60.784-28.115l-.072-29.127H127.6v-8.745h86.441s41.486 4.705 41.486-60.712c0-65.416-36.21-63.096-36.21-63.096h-21.61v30.355s1.165 36.21-35.632 36.21h-61.362s-34.475-.557-34.475 33.32v56.013s-5.235 33.897 62.518 33.897zm34.114-19.586a11.12 11.12 0 0 1-11.13-11.13 11.12 11.12 0 0 1 11.13-11.131 11.12 11.12 0 0 1 11.13 11.13 11.12 11.12 0 0 1-11.13 11.13z"/>
  </svg>
)
const LogoPowerBI = () => (
  <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    <rect width="48" height="48" rx="6" fill="#F2C811"/>
    <rect x="11" y="17" width="6.5" height="20" rx="2" fill="#1E1E1E"/>
    <rect x="20.5" y="11" width="6.5" height="26" rx="2" fill="#1E1E1E"/>
    <rect x="30" y="6" width="6.5" height="31" rx="2" fill="#1E1E1E"/>
  </svg>
)
const LogoSQL = () => (
  <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="32" cy="14" rx="21" ry="7" fill="none" stroke="#00758F" strokeWidth="2.8"/>
    <path d="M11 14v11c0 3.9 9.4 7 21 7s21-3.1 21-7V14" fill="none" stroke="#00758F" strokeWidth="2.8"/>
    <path d="M11 25v11c0 3.9 9.4 7 21 7s21-3.1 21-7V25" fill="none" stroke="#00758F" strokeWidth="2.8"/>
    <path d="M11 36v11c0 3.9 9.4 7 21 7s21-3.1 21-7V36" fill="none" stroke="#F29111" strokeWidth="2.8"/>
    <ellipse cx="32" cy="47" rx="21" ry="7" fill="none" stroke="#F29111" strokeWidth="2.8"/>
  </svg>
)
const LogoPandas = () => (
  <svg viewBox="0 0 100 110" xmlns="http://www.w3.org/2000/svg">
    <rect x="26" y="4"  width="14" height="42" rx="4" fill="#150458"/>
    <rect x="26" y="62" width="14" height="42" rx="4" fill="#150458"/>
    <rect x="43" y="24" width="14" height="42" rx="4" fill="#E70488"/>
    <rect x="9"  y="36" width="14" height="42" rx="4" fill="#E70488"/>
    <rect x="9"  y="4"  width="14" height="22" rx="4" fill="#150458"/>
    <rect x="43" y="80" width="14" height="24" rx="4" fill="#150458"/>
  </svg>
)
const LogoScikit = () => (
  <svg viewBox="0 0 120 80" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 62 Q16 16 60 16 Q104 16 104 62" fill="none" stroke="#F89939" strokeWidth="5.5" strokeLinecap="round"/>
    <circle cx="60" cy="16" r="8" fill="#3499CD"/>
    <circle cx="16" cy="62" r="8" fill="#3499CD"/>
    <circle cx="104" cy="62" r="8" fill="#3499CD"/>
    <path d="M35 52 L60 37 L85 52" fill="none" stroke="#3499CD" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    <circle cx="60" cy="37" r="5" fill="#F89939"/>
  </svg>
)
const LogoMatplotlib = () => (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="42" fill="none" stroke="#11557C" strokeWidth="3"/>
    <circle cx="50" cy="50" r="28" fill="none" stroke="#11557C" strokeWidth="2"/>
    <circle cx="50" cy="50" r="12" fill="#11557C"/>
    <line x1="50" y1="8" x2="50" y2="92" stroke="#11557C" strokeWidth="1.5"/>
    <line x1="8" y1="50" x2="92" y2="50" stroke="#11557C" strokeWidth="1.5"/>
    <line x1="20" y1="20" x2="80" y2="80" stroke="#11557C" strokeWidth="1"/>
    <line x1="20" y1="80" x2="80" y2="20" stroke="#11557C" strokeWidth="1"/>
  </svg>
)
const LogoExcel = () => (
  <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    <path fill="#185C37" d="M28 6H8a1 1 0 0 0-1 1v34a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1z"/>
    <path fill="#21A366" d="M40 6H28v36h12a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1z"/>
    <path fill="#107C42" d="M28 6h-5v36h5V6z"/>
    <path fill="white" d="M18 15l-3 5.5 3 5.5h-2.6L13.2 22 11 26H8.4l3.4-5.5-3.4-5.5H11l2.2 4 2.2-4H18z"/>
  </svg>
)
const LogoNumpy = () => (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <polygon points="50,8 86,28 86,72 50,92 14,72 14,28" fill="none" stroke="#4DABCF" strokeWidth="3"/>
    <polygon points="50,22 74,36 74,64 50,78 26,64 26,36" fill="none" stroke="#4DABCF" strokeWidth="2.2"/>
    <line x1="14" y1="28" x2="26" y2="36" stroke="#4DABCF" strokeWidth="2.2"/>
    <line x1="86" y1="28" x2="74" y2="36" stroke="#4DABCF" strokeWidth="2.2"/>
    <line x1="14" y1="72" x2="26" y2="64" stroke="#4DABCF" strokeWidth="2.2"/>
    <line x1="86" y1="72" x2="74" y2="64" stroke="#4DABCF" strokeWidth="2.2"/>
    <text x="50" y="57" textAnchor="middle" fill="#4DABCF" fontSize="18" fontWeight="700" fontFamily="monospace">Np</text>
  </svg>
)
      ...
      <section className="hero">
        <div className="hero-photo-panel">
          ...
          <div className="hp-avail u5">
            ...
            <div className="hp-avail-text"><strong>Open to Work</strong><span>Seeking Internships</span></div>
          </div>
        </div>
        ...
        <div className="wrap">
          ...
          <div className="bento">
            ...
            <div style={{gridColumn:'span 5',display:'grid',gap:12}}>
              <div className="card card-inv u2">
                <div className="card-sub" style={{color:'rgba(0,0,0,.35)'}}>hours logged</div>
            ...
            <div className="card card-c8 u3">
              <div className="card-sub">02 — philosophy</div>
              <h3>"Data is not just numbers — it's the story behind every decision."</h3>
              <p style={{marginTop:12}}>Analytical Thinking · Problem Solving · Communication · Adaptability</p>
            </div>
            <div className="card card-c4 card-inv u4" style={{display:'flex',flexDirection:'column',justifyContent:'space-between'}}>
              <div>
                <div className="card-sub" style={{color:'rgba(0,0,0,.3)'}}>03 — connect</div>
                <div className="sm">Let's work together on your next data project.</div>
              </div>
              <Link to="/contact" className="btn btn-dark" style={{marginTop:22,justifyContent:'center'}}>Get in Touch <Ar/></Link>
            </div>
          </div>
      ...
      <section className="sec sec-alt">
        <div className="wrap">
          ...
          <div className="skills-mosaic">
            {SKILLS.map(s => (<div className="sk-tile" key={s.name}><div className="sk-logo"><s.Logo/></div><div><div className="sk-name">{s.name}</div><div className="sk-cat">{s.cat}</div></div></div>))}
          </div>
        </div>
      </section>
      ...
      <section className="sec">
        <div className="wrap">
          ...
          <div className="proj-grid">
            {PROJECTS.map(p => (
              <div className="pj-card" key={p.title} data-n={p.n}>
