...
const CVLink = () => (
  <a href="/Anand_Bijoy_-_Business_analyst.pdf" target="_blank" rel="noreferrer" className="nav-cv">
    <DlSVG /> Resume
  </a>
)
      ...
      <nav className={`nav ${solid ? 'solid' : ''}`}>
        <div className="nav-inner">
          <Link to="/" className="nav-logo">
            <span className="nav-logo-bracket">[</span>AB<span className="nav-logo-dot"/><span className="nav-logo-bracket">]</span>
          </Link>
